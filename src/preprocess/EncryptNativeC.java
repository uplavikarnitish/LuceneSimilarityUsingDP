...
public class EncryptNativeC
{
	...
	public native int read_encrypt_vec_from_file_comp_inter_sec_prod(int vsizelocal, String input_encr_tfidf_file_name, String input_encr_bin_file_name, String input_unencr_tfidf_file_name, String input_unencr_bin_file_name, String output_file_name, String keyFileName, String rowCorrection_tfidf, String rowCorrection_bin);
